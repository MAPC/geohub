...
Click `mapc.github.io/geohub/` which will open a geohub landing page and click `Creative Enterprises Map` to open the choropleth map.
...
- Pick a colorblind-safe color ramp (including MAPC's own blue and green) or switch the basemap style (Light, Streets, Dark, or OpenStreetMap).
